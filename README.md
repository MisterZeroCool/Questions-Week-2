...
- [RecyclerView](#recyclerview)
  ...
  - [Чем отличается LinearLayout от RecycleView если оба использовать как отображение списка?](#Чем-отличается-LinearLayout)
...
### В чем разница между RecyclerView и ListView в Android?
